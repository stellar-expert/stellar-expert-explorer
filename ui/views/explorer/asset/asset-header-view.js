...
import {AccountAddress, InfoTooltip as Info, useAssetMeta, withErrorBoundary} from '@stellar-expert/ui-framework'
        ...
        <div className="row">
            <div className="column column-40">
                <h2>
                    ...
                    {asset.isContract && assetMeta?.code ?
                        assetMeta.code :
                        descriptor.isNative ?
                            'XLM - Stellar Lumens' :
                            descriptor.toCurrency()}
                    {' '}
                ...
                {!!descriptor.issuer && <div className="text-small" style={{margin: '-0.8em 0'}}>
                    ...
                    <Info link="https://www.stellar.org/developers/guides/concepts/assets.html#anchors-issuing-assets">
                        The issuing account from which the asset is issued. Assets are uniquely identified by the asset
                        code and
                        the issuer.
                    </Info>
                </div>}
